...
function provider(network) {
  if (network == 'polygon') {
    return new HDWalletProvider({
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/polygon.pk'))
          .toString()
          .trim()
      ],
  ...
  if (network == 'mumbai') {
    return new HDWalletProvider({
      ...
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/mumbai.pk'))
          .toString()
          .trim()
      ],
  ...
  if (network == 'amoy') {
    return new HDWalletProvider({
      ...
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/amoy.pk'))
          .toString()
          .trim()
      ],
  ...
  if (network == 'baseSepolia') {
    return new HDWalletProvider({
      ...
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/baseSepolia.pk'))
          .toString()
          .trim()
      ],
      providerOrUrl: 'https://base-sepolia.g.alchemy.com/v2/VAr-dttdNxi7WYf2ft4wNScXqrUzXRK3'
    })
  }
  ...
  if (network == 'base') {
    return new HDWalletProvider({
      ...
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/base.pk'))
          .toString()
          .trim()
      ],
  ...
  if (network == 'RedBellyTestnet') {
    return new HDWalletProvider({
      privateKeys: [
        fs
          .readFileSync(path.resolve(__dirname, './keystores/redBelly.pk'))
          .toString()
          .trim()
      ],
      providerOrUrl: 'https://governors.testnet.redbelly.network'
    })
  }
  ...
  return new HDWalletProvider({
    privateKeys: [
      fs
        .readFileSync(path.resolve(__dirname, '../.pk'))
        .toString()
        .trim()
    ],
    providerOrUrl:
